...
*/
	...
	s->s_ninodes = tmp->s_ninodes;
	s->s_nzones = tmp->s_nzones;
	s->s_imap_blocks = tmp->s_imap_blocks;
	s->s_zmap_blocks = tmp->s_zmap_blocks;
	s->s_firstdatazone = tmp->s_firstdatazone;
	s->s_log_zone_size = tmp->s_log_zone_size;
	s->s_max_size = tmp->s_max_size;
	s->s_magic = tmp->s_magic;
